...
public interface SettlementDao extends BaseDao<Object, Exception>{
	 ...
	 * @throws Exception
	 */
	public List<SettleCountInf> selectSettleCount(Map<String, Object> paramMap)  throws Exception;
	/**
	 * 更新状态为清算中
	 * @param paramMap
	 * @return
	...
	public List<SettleCountInf> selectT0T1Count(Map<String, Object> paramMap)  throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<SettleCountInf> selectCasPrd(Map<String, Object> paramMap)  throws Exception;
}
