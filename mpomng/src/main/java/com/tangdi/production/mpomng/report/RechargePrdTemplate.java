...
public class RechargePrdTemplate {
	...
	@ReportField(title="上游代理商编号")
	private String fathAgentId ;//上游代理商编号
	
	@ReportField(title="上游费率")
	private String fathRate;//上游费率
	
	@ReportField(title="上游手续费")
	private String fathFee;//上游手续费
	...
	public String getFathRate() {
		return fathRate;
	}

	public void setFathRate(String fathRate) {
		this.fathRate = fathRate;
	}

	public String getFathFee() {
		return fathFee;
	}

	public void setFathFee(String fathFee) {
		this.fathFee = fathFee;
	}
